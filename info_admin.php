                    ...
                    <tr>
                        ...
                        <div class="row-fluid">
                                <div class="span12" style="padding:10px;">  
                                    <a type="button" class="btn btn-primary" href="reportes/info_usuarios_pdf.php" target="_blank"><i class="icon-print"></i> Imprimir</a>
                                    <a type="button" class="btn" href="modificar_registro_admin.php"	 type="button" ><i class="icon-edit"></i> Modificar Registro</a>
                               </div>
                        </div>
